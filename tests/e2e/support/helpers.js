...
export const Card = {
	// Clubs
	aceOfClubs: {rank: 1, suit: 0},
	twoOfClubs: {rank: 2, suit: 0},
	threeOfClubs: {rank: 3, suit: 0},
	fourOfClubs: {rank: 4, suit: 0},
	fiveOfClubs: {rank: 5, suit: 0},
	sixOfClubs: {rank: 6, suit: 0},
	sevenOfClubs: {rank: 7, suit: 0},
	eightOfClubs: {rank: 8, suit: 0},
	nineOfClubs: {rank: 9, suit: 0},
	tenOfClubs: {rank: 10, suit: 0},
	jackOfClubs: {rank: 11, suit: 0},
	queenOfClubs: {rank: 12, suit: 0},
	kingOfClubs: {rank: 13, suit: 0},
	// Diamonds
	aceOfDiamonds: {rank: 1, suit: 1},
	twoOfDiamonds: {rank: 2, suit: 1},
	threeOfDiamonds: {rank: 3, suit: 1},
	fourOfDiamonds: {rank: 4, suit: 1},
	fiveOfDiamonds: {rank: 5, suit: 1},
	sixOfDiamonds: {rank: 6, suit: 1},
	sevenOfDiamonds: {rank: 7, suit: 1},
	eightOfDiamonds: {rank: 8, suit: 1},
	nineOfDiamonds: {rank: 9, suit: 1},
	tenOfDiamonds: {rank: 10, suit: 1},
	jackOfDiamonds: {rank: 11, suit: 1},
	queenOfDiamonds: {rank: 12, suit: 1},
	kingOfDiamonds: {rank: 13, suit: 1},
	// Hearts
	aceOfHearts: {rank: 1, suit: 2},
	twoOfHearts: {rank: 2, suit: 2},
	threeOfHearts: {rank: 3, suit: 2},
	fourOfHearts: {rank: 4, suit: 2},
	fiveOfHearts: {rank: 5, suit: 2},
	sixOfHearts: {rank: 6, suit: 2},
	sevenOfHearts: {rank: 7, suit: 2},
	eightOfHearts: {rank: 8, suit: 2},
	nineOfHearts: {rank: 9, suit: 2},
	tenOfHearts: {rank: 10, suit: 2},
	jackOfHearts: {rank: 11, suit: 2},
	queenOfHearts: {rank: 12, suit: 2},
	kingOfHearts: {rank: 13, suit: 2},
	// Spades
	aceOfSpades: {rank: 1, suit: 3},
	twoOfSpades: {rank: 2, suit: 3},
	threeOfSpades: {rank: 3, suit: 3},
	fourOfSpades: {rank: 4, suit: 3},
	fiveOfSpades: {rank: 5, suit: 3},
	sixOfSpades: {rank: 6, suit: 3},
	sevenOfSpades: {rank: 7, suit: 3},
	eightOfSpades: {rank: 8, suit: 3},
	nineOfSpades: {rank: 9, suit: 3},
	tenOfSpades: {rank: 10, suit: 3},
	jackOfSpades: {rank: 11, suit: 3},
	queenOfSpades: {rank: 12, suit: 3},
	kingOfSpades: {rank: 13, suit: 3},
}